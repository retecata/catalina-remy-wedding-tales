...
const travelInfo = {
  en: {
    ...
    travelText: 'The Netherlands is well connected by air via Amsterdam Schiphol Airport (AMS). From there, trains and buses connect to cities across the country.',
    ...
    diningText: 'Dinner and drinks will be provided. Please let us know of any dietary requirements when you RSVP.',
  },
  nl: {
    back: 'Terug',
    travelTitle: 'Bereikbaarheid',
    travelText: 'Nederland is goed bereikbaar via luchthaven Schiphol (AMS). Vanaf daar zijn er treinen en bussen naar steden door het hele land.',
    ...
    diningText: 'Diner en drankjes worden verzorgd. Laat ons weten of je dieetwensen hebt bij je RSVP.',
  },
  ro: {
    back: 'Înapoi',
