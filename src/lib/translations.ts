...
export const pageTranslations: Record<Language, {
  ...
  ro: {
    ...
    story: [
      'Era spre sfârșitul pandemiei și, ca mulți alții, amândoi ne refugiasem în gaming. Într-o zi, soarta ne-a aruncat în aceeași partidă de Apex Legends. După câteva runde în care ne-am sincronizat surprinzător de bine, Cătălina i-a zis lui Remy: |"Pot să rămân pentru totdeauna în echipa ta?"',
      ...
      'Apoi a venit marele pas — Cătălina a zburat în Olanda să-l cunoască pe Remy în realitate. Poate puțin nebunesc, dar din prima clipă în care s-au văzut, totul a căzut la locul lui. La scurt timp după, Remy a făcut și el drumul spre România.',
      '|"Nu știu dacă are viitor treaba asta,"| i-a spus Cătălina pe șleau. |"Am o carieră în Dublin și deocamdată nu mă mut de acolo."| Fără să stea pe gânduri, Remy a răspuns: |"Nicio problemă — mă mut eu."',
...
export const translations = {
  netherlands: {
    ...
    nl: {
      ...
      date: '5 september 2026',
      location: 'Brouwerskolkje, Overveen',
      description: 'De grote bruiloft vindt plaats in Roemenië op 11 september 2027.\n\nVoor een aantal van onze dierbaren organiseren we alvast een intieme viering hier in Nederland — maar het echte feest volgt nog, en daar hopen we iedereen bij te hebben!',
